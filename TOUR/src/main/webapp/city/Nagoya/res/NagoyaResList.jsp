...
<div class="tour-container">
    <%
    NagoyaResDAO resDAO = new NagoyaResDAO();
        List<NagoyaRes> ress = resDAO.getAllRess();

        for (NagoyaRes r : ress) {
    %>
    <div class="tour">
        <p><a href="NagoyaResdetail.jsp?tour_id=<%= r.getRes_id()%>"><%= r.getRes_name() %></a></p>
        <div class="all">
            <a href="NagoyaResetail.jsp?tour_id=<%= r.getRes_id()%>"><img src="<%=r.getRes_img1() %>"></img></a>
        </div>
    </div>
    <%
        }
