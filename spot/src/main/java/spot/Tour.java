...
public class Tour {
	...
	public Tour(int tour_id, String user_id, int city_id, String tour_name, String tour_location, String tour_phone, String tour_time, String tour_date, String tour_comment, String tour_img) {
